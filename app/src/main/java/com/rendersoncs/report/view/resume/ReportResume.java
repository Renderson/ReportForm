...
import com.rendersoncs.report.infrastructure.util.MyDividerItemDecoration;
...
public class ReportResume extends AppCompatActivity implements ReportResumeListener {
    ...
    private void openPDF() {
        openPdf.setOnClickListener(view -> {
            AccessDocumentPDF accessDocument = new AccessDocumentPDF(mReportId).invoke();
    ...
    public void fullPhoto(ReportResumeItems reportItems) {
        ...
        detailPhoto = new ReportDetailPhoto(
                photo,
                title,
                description,
                note,
