...
fun DeleteAccountScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collectLatest { event ->
            if (event is AccountEvent.AccountDeleted) {
                onDeleted()
            }
        }
    }
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        text = stringResource(R.string.label_menu_delete_account),
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.label_screen_remove_info),
            ...
            AuthCard {
                AuthTextField(
                    ...
                    onImeAction = viewModel::deleteAccount
                )
                Spacer(modifier = Modifier.height(20.dp))
                Button(
