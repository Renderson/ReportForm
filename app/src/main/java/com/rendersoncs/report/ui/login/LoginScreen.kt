    ...
    Scaffold(
        ...
        Column(
            ...
            AuthCard {
                ...
                Text(
                    text = stringResource(R.string.label_screen_login_hello),
                ...
                Text(
                    text = stringResource(R.string.label_screen_login_lets_go),
                ...
                TextButton(
                    ...
                    Text(
                        text = stringResource(R.string.label_screen_login_forgot_password),
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = stringResource(R.string.label_home_not_register),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
