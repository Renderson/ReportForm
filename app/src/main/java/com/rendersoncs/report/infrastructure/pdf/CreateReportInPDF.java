...
public class CreateReportInPDF {
    ...
    public File write(Context context, Report paramRepo) throws Exception {
        ...
        String str = FilenameUtils.normalize(String.format(context.getResources()
                ...
                paramRepo.companyFormatter(), paramRepo.dateFormatter()));
    ...
    private void addListItems(Context context, Report paramRepo, List listTitle, PdfPTable pTable) throws BadElementException, IOException {
        PdfPCell celTitle;
